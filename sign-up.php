...
<div class="wrapper">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          ...
          <div class="col-xs-6 col-xs-offset-3 latest-job ">
          ...
          <div class="row latest-job margin-top-20 margin-bottom-20">
          <div class="col-xs-6 col-xs-offset-3 latest-job ">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2016-2017 <a href="learningfromscratch.online">Job Board</a>.</strong> All rights
    reserved.
    </div>
  </footer>
